...
# Using picoprobe-cmsis-v1.0.2
openocd -f $W/interface/cmsis-dap.cfg -f $W/target/rp2040.cfg -c "adapter speed 5000" \
  -c "targets rp2040.core0; program build/busyboard.elf verify reset exit"
